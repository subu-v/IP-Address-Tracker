...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../images/icon-location.svg":[function(require,module,exports) {
module.exports = "/icon-location.9b40c3ce.svg";
...
var renderData = function renderData(data) {
  var ip = data.ip,
    ...
    postalCode = _data$location.postalCode,
    timezone = _data$location.timezone,
    isp = data.isp;
  ipField.textContent = ip;
  locationField.textContent = "".concat(city, ", ").concat(region, " ").concat(postalCode);
